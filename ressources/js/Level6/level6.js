...
class Level6 {
  static createLevel(thisGame) {
    ...
    palms.src = "/624-2_RIA_Let-sDrop/ressources/images/game/Level6/Palm.png";
  ...
  static detectCollisionsMonsters(thisGame) {
    ...
    if (
      thisGame.droppy.x + thisGame.droppy.width > 940 &&
      crab.life > 0 &&
    ...
    for (let i = 0; i < thisGame.gameObjects.length; i++) {
      if (thisGame.gameObjects[i] instanceof Defence) {
        ...
        let hit = thisGame.collisionRectRect(
          defence.x - defence.width / 2 + 5,
          defence.y - defence.height / 2 + 10,
          defence.width - 10,
          defence.height - 20,
          crab.x,
          crab.y,
